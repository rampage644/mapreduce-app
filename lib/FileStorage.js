...
(function () {
	...
	var X_STORAGE_URL_PREFIX = 'https://z.litestack.com/v1/';
	var SIGN_OUT_URL = 'https://z.litestack.com/login/google/?state=/js&code=logout';
	...
	FileStorage.listContainers = function (args) {
		...
		function getSharedContainers(xhr) {
			var allContainers = [];
	...
	FileStorage.addSharedContainer = function (args) {

		var xhr = new XMLHttpRequest();
		var url = 'https://z.litestack.com/load-share/' +  args.account + '/' + args.container;
		xhr.open('GET', url);
	...
	FileStorage.removeSharedContainer = function (args) {

		var xhr = new XMLHttpRequest();
		var url = 'https://z.litestack.com/drop-share/' + args.account + '/' + args.container;
		xhr.open('GET', url);
